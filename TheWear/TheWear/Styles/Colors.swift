...
enum Color {
    ...
    enum background {
        ...
        static let quinary = UIColor { trait in
            return UIColor(white: trait.userInterfaceStyle == .dark ? 1 : 0, alpha: 0.08)
        }
        
        static let quinarySolid = UIColor { trait in
    ...
    enum label {
        ...
        static let quaternary = UIColor { trait in
            return UIColor(white: trait.userInterfaceStyle == .dark ? 1 : 0, alpha: 0.16)
        }
    }
