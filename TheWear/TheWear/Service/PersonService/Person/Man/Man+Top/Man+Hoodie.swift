...
extension Man {
    ...
    final class func drawHoodie(_ color: UIColor, _ rain: Bool) -> UIView {
        ...
        let sweat = UIView()
        sweat.layer.addSublayers(pathLayer, path1Layer, path3Layer, path4Layer, path5Layer, path6Layer, path7Layer, path8Layer, path9Layer, path10Layer, path11Layer, path12Layer, shapeLayer, shape2Layer, path13Layer, path14Layer, combinedShapeLayer, combinedShape2Layer, headLayer)
        return sweat
    }
