...
extension Man {
    ...
    final class func drawBaseballCapForUndercut(_ color: UIColor) -> UIView {
        ...
        path4.move(to: CGPoint(x: 13.15, y: 33.28))
        path4.addLine(to: CGPoint(x: 17.65, y: 33.78))
        path4.addCurve(to: CGPoint(x: 20.75, y: 21.28), controlPoint1: CGPoint(x: 16.65, y: 26.28), controlPoint2: CGPoint(x: 17.87, y: 23.44))
        path4.addCurve(to: CGPoint(x: 21.51, y: 11.2), controlPoint1: CGPoint(x: 22.59, y: 19.9), controlPoint2: CGPoint(x: 19.01, y: 13.7))
        path4.addCurve(to: CGPoint(x: 7.65, y: 0.28), controlPoint1: CGPoint(x: 23.29, y: 9.42), controlPoint2: CGPoint(x: 10.95, y: -1.92))
        path4.addCurve(to: CGPoint(x: 3.84, y: 9.55), controlPoint1: CGPoint(x: 4.35, y: 2.48), controlPoint2: CGPoint(x: 9.63, y: -2.25))
        path4.addCurve(to: CGPoint(x: 3.85, y: 40.8), controlPoint1: CGPoint(x: -1.94, y: 21.34), controlPoint2: CGPoint(x: -0.58, y: 31.74))
        path4.addLine(to: CGPoint(x: 4.82, y: 40.8))
        path4.addCurve(to: CGPoint(x: 6.15, y: 23.28), controlPoint1: CGPoint(x: 0.82, y: 30.05), controlPoint2: CGPoint(x: 0.65, y: 23.78))
        path4.addCurve(to: CGPoint(x: 13.15, y: 33.28), controlPoint1: CGPoint(x: 11.65, y: 22.78), controlPoint2: CGPoint(x: 13.15, y: 33.28))
        path4.close()
        let path4Layer = createLayer(path4, Color.shadow.medium, CGPoint(x: 107.9, y: 49.55))
