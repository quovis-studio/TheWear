...
extension Man {
    ...
    final class func drawBaseballCapForShort(_ color: UIColor) -> UIView {
        ...
        let path4 = UIBezierPath() // Hair
        path4.move(to: CGPoint(x: 17.03, y: 40.66))
        path4.addLine(to: CGPoint(x: 21.53, y: 41.16))
        path4.addCurve(to: CGPoint(x: 23.45, y: 29.43), controlPoint1: CGPoint(x: 20.53, y: 33.66), controlPoint2: CGPoint(x: 20.94, y: 32.03))
        path4.addCurve(to: CGPoint(x: 23.66, y: 21.71), controlPoint1: CGPoint(x: 24.69, y: 28.15), controlPoint2: CGPoint(x: 22.08, y: 23.29))
        path4.addCurve(to: CGPoint(x: 42.9, y: 19.99), controlPoint1: CGPoint(x: 26.16, y: 19.21), controlPoint2: CGPoint(x: 36.44, y: 20.74))
        path4.addCurve(to: CGPoint(x: 53.19, y: 13.85), controlPoint1: CGPoint(x: 51.4, y: 18.99), controlPoint2: CGPoint(x: 54.92, y: 17.15))
        path4.addCurve(to: CGPoint(x: 5.03, y: 10.16), controlPoint1: CGPoint(x: 43.19, y: -5.15), controlPoint2: CGPoint(x: 13.53, y: -2.84))
        path4.addCurve(to: CGPoint(x: 6.53, y: 48.16), controlPoint1: CGPoint(x: -3.47, y: 23.16), controlPoint2: CGPoint(x: 0.03, y: 38.66))
        path4.addLine(to: CGPoint(x: 9.03, y: 48.16))
        path4.addCurve(to: CGPoint(x: 10.03, y: 30.66), controlPoint1: CGPoint(x: 3.53, y: 37.16), controlPoint2: CGPoint(x: 4.53, y: 31.16))
        path4.addCurve(to: CGPoint(x: 17.03, y: 40.66), controlPoint1: CGPoint(x: 15.53, y: 30.16), controlPoint2: CGPoint(x: 17.03, y: 40.66))
        path4.close()
        let path4Layer = createLayer(path4, hairColor, CGPoint(x: 103.98, y: 42.09))
