...
extension Man {
    ...
    final class func drawBaseballCapForAfro(_ color: UIColor) -> UIView {
        ...
        path4.move(to: CGPoint(x: 17.82, y: 18.04))
        path4.addLine(to: CGPoint(x: 22.32, y: 18.54))
        path4.addCurve(to: CGPoint(x: 24.24, y: 6.81), controlPoint1: CGPoint(x: 21.32, y: 11.04), controlPoint2: CGPoint(x: 21.73, y: 9.41))
        path4.addCurve(to: CGPoint(x: 24.24, y: 0), controlPoint1: CGPoint(x: 25.48, y: 5.53), controlPoint2: CGPoint(x: 22.66, y: 1.58))
        path4.addCurve(to: CGPoint(x: 0.16, y: 11.21), controlPoint1: CGPoint(x: 24.24, y: 0), controlPoint2: CGPoint(x: 0.95, y: 6.15))
        path4.addCurve(to: CGPoint(x: 7.32, y: 25.54), controlPoint1: CGPoint(x: -0.62, y: 16.28), controlPoint2: CGPoint(x: 1.4, y: 20.91))
        path4.addLine(to: CGPoint(x: 9.82, y: 25.54))
        path4.addCurve(to: CGPoint(x: 10.82, y: 8.04), controlPoint1: CGPoint(x: 4.32, y: 14.54), controlPoint2: CGPoint(x: 5.32, y: 8.54))
        path4.addCurve(to: CGPoint(x: 17.82, y: 18.04), controlPoint1: CGPoint(x: 16.32, y: 7.54), controlPoint2: CGPoint(x: 17.82, y: 18.04))
        path4.close()
        let path4Layer = createLayer(path4, hairColor, CGPoint(x: 103.19, y: 64.72))
