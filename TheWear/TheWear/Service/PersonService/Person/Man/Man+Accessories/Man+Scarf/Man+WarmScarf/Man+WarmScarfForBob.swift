...
extension Man {
    ...
    final class func drawWarmScarfForBob(_ color: UIColor) -> UIView {
        ...
        let scarf = UIView()
        scarf.layer.addSublayers(path0Layer, pathLayer, path2Layer, path3Layer, path4Layer, path5Layer, path6Layer, path7Layer, combinedShapeLayer, path8Layer, path9Layer, headLayer, path13Layer)
        return scarf
    }
