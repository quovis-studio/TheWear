...
extension Man {
    ...
    final class func drawStar4() -> UIView {
        ...
        star4Path.addCurve(to: CGPoint(x: 25.56, y: 12.73), controlPoint1: CGPoint(x: 24.21, y: 11.68), controlPoint2: CGPoint(x: 24.76, y: 12.42))
        star4Path.addLine(to: CGPoint(x: 33.76, y: 15.97))
        star4Path.addCurve(to: CGPoint(x: 33.83, y: 20.18), controlPoint1: CGPoint(x: 35.64, y: 16.72), controlPoint2: CGPoint(x: 35.69, y: 19.37))
        star4Path.addLine(to: CGPoint(x: 25.75, y: 23.71))
        star4Path.addCurve(to: CGPoint(x: 24.39, y: 25.65), controlPoint1: CGPoint(x: 24.96, y: 24.05), controlPoint2: CGPoint(x: 24.44, y: 24.8))
        star4Path.addLine(to: CGPoint(x: 23.83, y: 34.45))
        star4Path.addCurve(to: CGPoint(x: 19.86, y: 35.82), controlPoint1: CGPoint(x: 23.71, y: 36.47), controlPoint2: CGPoint(x: 21.2, y: 37.34))
        star4Path.addLine(to: CGPoint(x: 14.01, y: 29.22))
        star4Path.addCurve(to: CGPoint(x: 11.74, y: 28.53), controlPoint1: CGPoint(x: 13.44, y: 28.59), controlPoint2: CGPoint(x: 12.56, y: 28.32))
        star4Path.addLine(to: CGPoint(x: 3.2, y: 30.73))
        ...
        star4Path.addCurve(to: CGPoint(x: 13.63, y: 7.62), controlPoint1: CGPoint(x: 12.22, y: 8.58), controlPoint2: CGPoint(x: 13.09, y: 8.28))
        star4Path.addLine(to: CGPoint(x: 19.25, y: 0.83))
        star4Path.close()
        let star4Layer = createLayer(star4Path, starColor, .zero)
        
        let star4View = UIView(frame: .init(x: 122.76, y: 14.16, width: 35.2, height: 36.59))
    ...
    final class func drawPhone2() -> UIView {
        ...
        let phone2View = UIView(frame: .init(x: 178.83, y: 110.52, width: 32.94, height: 38.49))
    ...
    final class func drawPhone1() -> UIView {
        ...
        let phone1View = UIView(frame: .init(x: 180.41, y: 112.1, width: 32.94, height: 38.49))
    ...
    final class func drawBorder2() -> UIView {
        ...
        let border2View = UIView(frame: .init(x: 208.22, y: 110.93, width: 5.12, height: 4.37))
    ...
    final class func drawBorder1() -> UIView {
        ...
        let border1View = UIView(frame: .init(x: 179.23, y: 145.11, width: 3.7, height: 5.41))
    ...
    final class func drawArm() -> UIView {
        ...
        armPath.move(to: CGPoint(x: 30.53, y: 15.94))
        armPath.addCurve(to: CGPoint(x: 26.57, y: 33.52), controlPoint1: CGPoint(x: 29.7, y: 19.89), controlPoint2: CGPoint(x: 26.57, y: 29.71))
        armPath.addLine(to: CGPoint(x: 12.1, y: 32.9))
        armPath.addCurve(to: CGPoint(x: 10, y: 27.85), controlPoint1: CGPoint(x: 12.46, y: 31.51), controlPoint2: CGPoint(x: 11.06, y: 29.34))
        armPath.addCurve(to: CGPoint(x: 4.07, y: 22.88), controlPoint1: CGPoint(x: 8.95, y: 26.36), controlPoint2: CGPoint(x: 7.1, y: 25.76))
        armPath.addCurve(to: CGPoint(x: 0.53, y: 9.9), controlPoint1: CGPoint(x: 1.04, y: 19.99), controlPoint2: CGPoint(x: -1.02, y: 14.58))
        armPath.addCurve(to: CGPoint(x: 6.17, y: 3.14), controlPoint1: CGPoint(x: 2.08, y: 5.22), controlPoint2: CGPoint(x: 3.28, y: 4))
        armPath.addCurve(to: CGPoint(x: 16.79, y: 7.29), controlPoint1: CGPoint(x: 9.06, y: 2.28), controlPoint2: CGPoint(x: 13.35, y: 4.93))
        armPath.addCurve(to: CGPoint(x: 26.63, y: 12.35), controlPoint1: CGPoint(x: 20.24, y: 9.65), controlPoint2: CGPoint(x: 23.5, y: 12.06))
        armPath.addLine(to: CGPoint(x: 31.05, y: 0))
        armPath.addCurve(to: CGPoint(x: 30.53, y: 15.94), controlPoint1: CGPoint(x: 34.82, y: 0.69), controlPoint2: CGPoint(x: 31.36, y: 12))
        armPath.close()
        let armPathLayer = createLayer(armPath, skinColor, .zero)
        
        let armView = UIView(frame: .init(x: 179.76, y: 124.16, width: 32.78, height: 33.52))
