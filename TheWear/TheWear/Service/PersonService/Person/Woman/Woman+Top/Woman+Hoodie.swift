...
extension Woman {
    ...
    final class func drawHoodie(_ color: UIColor, _ rain: Bool) -> UIView {
        ...
        let top = UIView()
        top.layer.addSublayers(path0Layer, pathLayer, path2Layer, path01Layer, path02Layer, path3Layer, path4Layer, path03Layer, path5Layer, path6Layer, path7Layer, path8Layer, path9Layer, shapeLayer, path10Layer, shape2Layer, combLayer, comb2Layer, path11Layer)
        return top
    }
