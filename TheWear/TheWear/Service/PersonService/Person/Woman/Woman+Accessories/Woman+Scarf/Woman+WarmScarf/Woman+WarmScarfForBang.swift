...
extension Woman {
    ...
    final class func drawWarmScarfForBang(color: UIColor) -> UIView {
        ...
        path13.move(to: CGPoint(x: 13.66, y: 21.35))
        path13.addCurve(to: CGPoint(x: 16.73, y: 3.94), controlPoint1: CGPoint(x: 8.16, y: 10.35), controlPoint2: CGPoint(x: 11.23, y: 4.44))
        path13.addLine(to: CGPoint(x: 6.84, y: 0))
        path13.addCurve(to: CGPoint(x: 1.66, y: 66.82), controlPoint1: CGPoint(x: 8.18, y: 21.88), controlPoint2: CGPoint(x: -4.4, y: 55.56))
        path13.addCurve(to: CGPoint(x: 24.97, y: 73.79), controlPoint1: CGPoint(x: 7.73, y: 78.07), controlPoint2: CGPoint(x: 22.72, y: 80.06))
        path13.addCurve(to: CGPoint(x: 20.21, y: 36.76), controlPoint1: CGPoint(x: 26.31, y: 70.06), controlPoint2: CGPoint(x: 22.15, y: 44.25))
        path13.addCurve(to: CGPoint(x: 13.66, y: 21.35), controlPoint1: CGPoint(x: 18.27, y: 29.28), controlPoint2: CGPoint(x: 14.3, y: 22.65))
        path13.close()
        let path13Layer = createLayer(path13, hairColor, CGPoint(x: 101.65, y: 68.09))
