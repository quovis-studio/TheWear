...
extension Woman {
    ...
    final class func drawWarmScarfForPigtails(color: UIColor) -> UIView {
        ...
        path11.move(to: CGPoint(x: 16.28, y: 24.99))
        path11.addCurve(to: CGPoint(x: 23.43, y: 31.85), controlPoint1: CGPoint(x: 21.78, y: 24.49), controlPoint2: CGPoint(x: 21.6, y: 31.17))
        path11.addCurve(to: CGPoint(x: 42.32, y: 19.58), controlPoint1: CGPoint(x: 25.26, y: 32.52), controlPoint2: CGPoint(x: 30.13, y: 25.75))
        path11.addCurve(to: CGPoint(x: 48.46, y: 11.42), controlPoint1: CGPoint(x: 54.52, y: 13.42), controlPoint2: CGPoint(x: 50.32, y: 15.73))
        path11.addCurve(to: CGPoint(x: 26.65, y: 2.09), controlPoint1: CGPoint(x: 44.57, y: 2.4), controlPoint2: CGPoint(x: 35.42, y: 3.25))
        path11.addCurve(to: CGPoint(x: 2.56, y: 9.09), controlPoint1: CGPoint(x: 17.88, y: 0.93), controlPoint2: CGPoint(x: 11.32, y: -4.62))
        path11.addCurve(to: CGPoint(x: 0.82, y: 31.85), controlPoint1: CGPoint(x: -3.37, y: 18.38), controlPoint2: CGPoint(x: 3.19, y: 19.57))
        path11.addCurve(to: CGPoint(x: 3.86, y: 53.59), controlPoint1: CGPoint(x: -0.85, y: 40.51), controlPoint2: CGPoint(x: 7.85, y: 41.9))
        path11.addCurve(to: CGPoint(x: 4.55, y: 74.46), controlPoint1: CGPoint(x: -0.13, y: 65.28), controlPoint2: CGPoint(x: 6.42, y: 65.04))
        path11.addCurve(to: CGPoint(x: 6.53, y: 94.91), controlPoint1: CGPoint(x: 2.68, y: 83.89), controlPoint2: CGPoint(x: 8.6, y: 87.59))
        path11.addCurve(to: CGPoint(x: 10.06, y: 109.93), controlPoint1: CGPoint(x: 4.46, y: 102.24), controlPoint2: CGPoint(x: 9.41, y: 106.33))
        path11.addCurve(to: CGPoint(x: 14.2, y: 135.27), controlPoint1: CGPoint(x: 7.16, y: 118.11), controlPoint2: CGPoint(x: 9.99, y: 135.16))
        path11.addCurve(to: CGPoint(x: 18.42, y: 109.93), controlPoint1: CGPoint(x: 18.42, y: 135.37), controlPoint2: CGPoint(x: 22.82, y: 121.25))
        path11.addCurve(to: CGPoint(x: 21.08, y: 97.79), controlPoint1: CGPoint(x: 18.42, y: 104.91), controlPoint2: CGPoint(x: 20.43, y: 103.43))
        path11.addCurve(to: CGPoint(x: 20.5, y: 87.95), controlPoint1: CGPoint(x: 21.72, y: 92.15), controlPoint2: CGPoint(x: 18.77, y: 92.51))
        path11.addCurve(to: CGPoint(x: 21.39, y: 72), controlPoint1: CGPoint(x: 22.23, y: 83.4), controlPoint2: CGPoint(x: 22.37, y: 77.1))
        path11.addCurve(to: CGPoint(x: 21.39, y: 58.1), controlPoint1: CGPoint(x: 20.41, y: 66.9), controlPoint2: CGPoint(x: 20.5, y: 62.79))
        path11.addCurve(to: CGPoint(x: 15.12, y: 40.92), controlPoint1: CGPoint(x: 22.28, y: 53.41), controlPoint2: CGPoint(x: 18.42, y: 47.51))
        path11.addCurve(to: CGPoint(x: 16.28, y: 24.99), controlPoint1: CGPoint(x: 9.62, y: 29.92), controlPoint2: CGPoint(x: 10.78, y: 25.49))
        path11.close()
        
        let path12 = UIBezierPath()
        path12.move(to: CGPoint(x: 0.35, y: 0.85))
        path12.addCurve(to: CGPoint(x: 0.65, y: 4.9), controlPoint1: CGPoint(x: -0.25, y: 1.49), controlPoint2: CGPoint(x: -0.04, y: 4.32))
        path12.addCurve(to: CGPoint(x: 10.29, y: 4.81), controlPoint1: CGPoint(x: 1.26, y: 5.42), controlPoint2: CGPoint(x: 9.78, y: 5.47))
        path12.addCurve(to: CGPoint(x: 10.06, y: 0.46), controlPoint1: CGPoint(x: 10.83, y: 4.11), controlPoint2: CGPoint(x: 10.57, y: 1))
        path12.addCurve(to: CGPoint(x: 0.35, y: 0.85), controlPoint1: CGPoint(x: 9.26, y: -0.39), controlPoint2: CGPoint(x: 1.09, y: 0.06))
        path12.close()
        
        let path11Layer = createLayer(path11, hairColor, CGPoint(x: 102.5, y: 47.63))
        let path12Layer = createLayer(path12, UIColor(60, 58, 58), CGPoint(x: 111.35, y: 153.58))
        
        let scarf = UIView()
        scarf.layer.addSublayers(path2Layer, path3Layer, path4Layer, path5Layer, path6Layer, path7Layer, path8Layer, combinedShapeLayer, path9Layer, path10Layer, pathLayer, bendLayer, headLayer, path11Layer, path12Layer)
        return scarf
    }
