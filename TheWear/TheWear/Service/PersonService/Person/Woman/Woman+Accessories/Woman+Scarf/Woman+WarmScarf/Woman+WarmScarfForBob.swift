...
extension Woman {
    ...
    final class func drawWarmScarfForBob(color: UIColor) -> UIView {
        ...
        path13.move(to: CGPoint(x: 12.61, y: 29.49))
        path13.addCurve(to: CGPoint(x: 24.13, y: 11.98), controlPoint1: CGPoint(x: 10.46, y: 17.74), controlPoint2: CGPoint(x: 18.63, y: 12.48))
        path13.addLine(to: CGPoint(x: 7.86, y: 0))
        path13.addCurve(to: CGPoint(x: 1.08, y: 61.01), controlPoint1: CGPoint(x: 2.21, y: 16.38), controlPoint2: CGPoint(x: -2.1, y: 58.79))
        path13.addCurve(to: CGPoint(x: 19.77, y: 63.19), controlPoint1: CGPoint(x: 4.27, y: 63.24), controlPoint2: CGPoint(x: 7.35, y: 64.37))
        path13.addCurve(to: CGPoint(x: 12.61, y: 29.49), controlPoint1: CGPoint(x: 32.2, y: 62.02), controlPoint2: CGPoint(x: 14.19, y: 38.15))
        path13.close()
        let path13Layer = createLayer(path13, hairColor, CGPoint(x: 104.04, y: 61.37))
